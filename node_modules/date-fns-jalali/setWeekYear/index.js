...
var _index9 = _interopRequireDefault(require("../_core/setFullYear/index.js"));

var _index10 = _interopRequireDefault(require("../_core/newDate/index.js"));
...
function setWeekYear(dirtyDate, dirtyWeekYear, options) {
  ...
  var firstWeek = (0, _index10.default)(0);
  (0, _index9.default)(firstWeek, weekYear, 0, firstWeekContainsDate);
  firstWeek.setHours(0, 0, 0, 0);
  date = (0, _index2.default)(firstWeek, options);
  (0, _index8.default)(date, (0, _index7.default)(date) + diff);
  return date;
}

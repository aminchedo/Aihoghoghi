...
var _index3 = _interopRequireDefault(require("../../../_core/setUTCFullYear/index.js"));
  ...
  _createClass(LocalWeekYearParser, [{
    ...
    value: function set(date, flags, value, options) {
      ...
      if (value.isTwoDigitYear) {
        ...
        (0, _index3.default)(date, normalizedTwoDigitYear, 0, options.firstWeekContainsDate);
        date.setUTCHours(0, 0, 0, 0);
        return (0, _index2.default)(date, options);
      }

      var year = !('era' in flags) || flags.era === 1 ? value.year : 1 - value.year;
      (0, _index3.default)(date, year, 0, options.firstWeekContainsDate);
      date.setUTCHours(0, 0, 0, 0);
      return (0, _index2.default)(date, options);
    }
  }]);
